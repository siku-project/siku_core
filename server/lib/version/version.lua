...
local ENABLED <const> = VersionConfig.enabled ~= false

local parseVersion <const> = _SikuInternal.ParseVersion
local compareVersions <const> = _SikuInternal.CompareVersions
...
--- Compare the calling resource against its latest GitHub release and log the outcome.
...
function Siku.VersionCheck(repository)
